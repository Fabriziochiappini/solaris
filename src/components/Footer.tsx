      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-7xl mx-auto px-8">
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            <a href="tel:+393421073857" className="flex items-center gap-2 text-sm font-bold text-sky-900 hover:text-sky-600 transition-colors">
              <span className="material-symbols-outlined text-base">phone</span>
              +39 342 107 3857
            </a>
            <a href="https://wa.me/393421073857" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm font-bold text-[#25D366] hover:opacity-80 transition-opacity">
